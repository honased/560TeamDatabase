...
Invoke-SqlCmd -ServerInstance $Server -Database $Database -Variable $Variables -InputFile $PSScriptRoot\"NetflixData\Sql\Data\InsertSpreadsheetData.sql"
Invoke-SqlCmd -ServerInstance $Server -Database $Database -InputFile $PSScriptRoot\"NetflixData\Sql\Data\InsertShows.sql"
Invoke-SqlCmd -ServerInstance $Server -Database $Database -InputFile $PSScriptRoot\"NetflixData\Sql\Data\InsertGenres.sql"
Invoke-SqlCmd -ServerInstance $Server -Database $Database -InputFile $PSScriptRoot\"NetflixData\Sql\Data\InsertShowGenres.sql"
Invoke-SqlCmd -ServerInstance $Server -Database $Database -InputFile $PSScriptRoot\"NetflixData\Sql\Data\InsertPeople.sql"
Invoke-SqlCmd -ServerInstance $Server -Database $Database -InputFile $PSScriptRoot\"NetflixData\Sql\Data\InsertActors.sql"
Invoke-SqlCmd -ServerInstance $Server -Database $Database -InputFile $PSScriptRoot\"NetflixData\Sql\Data\InsertDirectors.sql"
Invoke-SqlCmd -ServerInstance $Server -Database $Database -InputFile $PSScriptRoot\"NetflixData\Sql\Data\InsertUsers.sql"
Invoke-SqlCmd -ServerInstance $Server -Database $Database -InputFile $PSScriptRoot\"NetflixData\Sql\Data\InsertUserShowLibrary.sql"
Invoke-SqlCmd -ServerInstance $Server -Database $Database -InputFile $PSScriptRoot\"NetflixData\Sql\Data\InsertShowReviews.sql"
Invoke-SqlCmd -ServerInstance $Server -Database $Database -InputFile $PSScriptRoot\"NetflixData\Sql\Data\InsertShowWatchLog.sql"
